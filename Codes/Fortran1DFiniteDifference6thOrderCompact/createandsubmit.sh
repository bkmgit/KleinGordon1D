...
do
  ...
  do
    ...
    sed -i "70s/Nx=1024/Nx=${i}/"  KgSemiImp1d${i}and${tt}.f90
    sed -i "71s/Nt=500/Nt=${tt}/"  KgSemiImp1d${i}and${tt}.f90
    ...
    sed -i "2s/#PBS -N FD/#PBS -N FD${i}and${tt}/" subscriptKabuki${i}and${tt}
